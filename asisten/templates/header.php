...
<div class="flex h-screen bg-gray-100">
    <!-- Sidebar -->
    <aside class="w-64 bg-gray-800 text-white flex flex-col" style="height: 100vh; position: fixed;">
        ...
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                ...
                <li>
                 ...
                 <li>
                    <a href="manage_praktikum.php" class="<?php echo ($activePage == 'praktikum') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                ...
                <li>
                 ...
                 <li>
                    <a href="pengguna.php" class="<?php echo ($activePage == 'users') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
    ...
    <!-- Main Content -->
    <div class="flex-1 flex flex-col" style="margin-left: 16rem;"> <!-- 16rem = w-64 -->
